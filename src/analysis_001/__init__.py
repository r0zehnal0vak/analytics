...
class SineWave(param.Parameterized):
    ...
    startdate  = param.Date(default=datetime.datetime(2024, 4, 24))
    enddate  = param.Date(default=datetime.datetime(2024, 4, 25))
    ...
    def __init__(self, **params):
        ...
        cookiesdict = pn.state.cookies
        print("cookiesdict", cookiesdict)
        self.data = DataFrame([{**cookiesdict, "a": "value a0", "b": "value b0"}, {**cookiesdict, "a": "value a1", "b": "value b1"}])
...
def createApp():
    ...
    return pn.Row(sw.param, sw.data).servable()